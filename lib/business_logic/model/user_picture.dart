...
class UserPicture{
  ...
  UserPicture({this.drawnLines,this.isLock,this.bgImageUrl,this.createDateTime,this.thumbnailName});
  ...
  factory UserPicture.fromJson(Map<String,dynamic> json){
    return UserPicture(
      ...
      drawnLines: CommonUtil.jsonToList(
        json,DrawnLine.fromJson,'drawnLines'
      )
    );
  }
}